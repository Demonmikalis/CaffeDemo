...
static void testSSD()
{
  ...
  net.reset(new Net<float>("./models/MobileNetSSD_deploy.prototxt", TEST));
  ...
  for (auto& bbox : detections) {
    ...
    cv::putText(img, buff, cv::Point(bbox.x1, bbox.y1), 
